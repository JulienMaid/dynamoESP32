...
public:
  ...
  GestionLed(uint32_t p_u32_PortLed = 0, bool p_b_AutonomousOperation = true,
  ...
  //! Retourne la valeur courante de la séquence d'allumage
  //! @param p_b_Reverse complémente la value normalement retournée
  virtual uint8_t GetSequence(bool p_b_Reverse = false);
